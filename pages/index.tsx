    ...
    <>
      <div className="h-full w-full absolute ">
        <div className="md:p-10 p-4 w-full h-full fixed">
          <div className="border-[1px] shadow-slate-200  border-white w-full h-full rounded-none overflow-y-auto overflow-x-hidden  flex flex-col items-center relative" id="ScrollContainer">
            ...
            {/* EXPERIENCE SECTION  */}
            <h1 className="font-[Poppins] text-left md:w-[85%] w-[90%] md:text-[40px] text-2xl mb-14"> EXPERIENCE . . . </h1>
            ...
            {/*ABOUT Section*/}
            <h1 className="font-[Poppins] text-center w-[90%] md:text-[43px]  font-bold text-3xl my-14">ABOUT US </h1>
            <section className="w-full p-5 flex md:flex-row flex-col items-center justify-evenly text-center"> 
              <div className="md:w-[30%] w-[90%] text-white mb-10">
                <h2 className="md:text-4xl text-2xl md:font-bold font-semibold mb-3 text-rose-300 leading-tight">Stories in Wood</h2>
              ...
              <div className="md:w-[30%] w-[90%] text-white mb-10">
                <h2 className="md:text-4xl text-2xl md:font-bold font-semibold mb-3 text-blue-300 leading-tight">Elegance, Comfort, and You</h2>
                <p className="text-gray-400 leading-loose">
            ...
            <section className="w-full p-5 flex md:flex-row flex-col items-center justify-evenly text-center">
              <div className="md:w-[50%] w-[90%] text-white">
                <h2 className="md:text-4xl text-2xl md:font-bold font-semibold mb-3 text-teal-400 leading-tight">Get in Touch</h2>
                <p className="text-gray-400 leading-loose">
